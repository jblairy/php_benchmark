...
final class BenchmarkStatisticsDataTest extends TestCase
{
    ...
    public function testGetP50ReturnsPercentilesP50(): void
    {
        // Arrange
        $percentiles = new PercentileMetrics(
            p50: 1.5,
    ...
    public function testGetP80ReturnsPercentilesP80(): void
    {
        // Arrange
        $percentiles = new PercentileMetrics(
            p50: 1.5,
    ...
    public function testGetP90ReturnsPercentilesP90(): void
    {
        // Arrange
        $percentiles = new PercentileMetrics(
            p50: 1.5,
    ...
    public function testGetP95ReturnsPercentilesP95(): void
    {
        // Arrange
        $percentiles = new PercentileMetrics(
            p50: 1.5,
    ...
    public function testGetP99ReturnsPercentilesP99(): void
    {
        // Arrange
        $percentiles = new PercentileMetrics(
            p50: 1.5,
